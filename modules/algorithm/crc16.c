...
/**
  ...
  */
uint16_t Get_CRC16_Check_Sum_1(const uint8_t * pchMessage, uint32_t dwLength, uint16_t wCRC)
{
  uint8_t ch_data;
...
uint32_t Verify_CRC16_Check_Sum_1(const uint8_t * pchMessage, uint32_t dwLength)
{
  ...
  w_expected = Get_CRC16_Check_Sum_1(pchMessage, dwLength - 2, CRC16_INIT);
  return (
...
void Append_CRC16_Check_Sum_1(uint8_t * pchMessage, uint32_t dwLength)
{
  ...
  w_crc = Get_CRC16_Check_Sum_1((pchMessage), dwLength - 2, CRC16_INIT);
