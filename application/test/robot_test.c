...
void NUC_init(void)
{
	...
	Vision_Send.Header_Frame.id 				= 0x01;
	Vision_Send.Header_Frame.len				= 57;
...
void NUC_Send_Data(){
	...
	Vision_Send.check_sum 		= Check_Sum_16(&Vision_Send.Header_Frame.head,sizeof(vision_send_t)-3);
